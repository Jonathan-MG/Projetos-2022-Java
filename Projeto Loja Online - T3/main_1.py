...
item_2 = Item(valor = 350.0, nome = 'God of War', descricao = 'Kleiton - O Bom de Guerra',keyword = " ", imagem = " ")
item_3 = Item(valor = 350.0, nome = 'God of War', descricao = 'Kleiton - O Bom de Guerra',keyword = " ", imagem = " ")
